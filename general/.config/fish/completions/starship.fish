...
complete -c starship -n "__fish_seen_subcommand_from prompt" -l pipestatus -d 'Status codes from a command pipeline'
complete -c starship -n "__fish_seen_subcommand_from prompt" -s w -l terminal-width -d 'The width of the current interactive terminal.'
...
complete -c starship -n "__fish_seen_subcommand_from module" -l pipestatus -d 'Status codes from a command pipeline'
complete -c starship -n "__fish_seen_subcommand_from module" -s w -l terminal-width -d 'The width of the current interactive terminal.'
...
complete -c starship -n "__fish_seen_subcommand_from print-config" -s h -l help -d 'Prints help information'
complete -c starship -n "__fish_seen_subcommand_from print-config" -s V -l version -d 'Prints version information'
...
complete -c starship -n "__fish_seen_subcommand_from explain" -s s -l status -d 'The status code of the previously run command'
complete -c starship -n "__fish_seen_subcommand_from explain" -l pipestatus -d 'Status codes from a command pipeline'
complete -c starship -n "__fish_seen_subcommand_from explain" -s w -l terminal-width -d 'The width of the current interactive terminal.'
complete -c starship -n "__fish_seen_subcommand_from explain" -s p -l path -d 'The path that the prompt should render for.'
complete -c starship -n "__fish_seen_subcommand_from explain" -s P -l logical-path -d 'The logical path that the prompt should render for. This path should be a virtual/logical representation of the PATH argument.'
complete -c starship -n "__fish_seen_subcommand_from explain" -s d -l cmd-duration -d 'The execution duration of the last command, in milliseconds'
complete -c starship -n "__fish_seen_subcommand_from explain" -s k -l keymap -d 'The keymap of fish/zsh'
complete -c starship -n "__fish_seen_subcommand_from explain" -s j -l jobs -d 'The number of currently running jobs'
...
complete -c starship -n "__fish_seen_subcommand_from timings" -s s -l status -d 'The status code of the previously run command'
complete -c starship -n "__fish_seen_subcommand_from timings" -l pipestatus -d 'Status codes from a command pipeline'
complete -c starship -n "__fish_seen_subcommand_from timings" -s w -l terminal-width -d 'The width of the current interactive terminal.'
complete -c starship -n "__fish_seen_subcommand_from timings" -s p -l path -d 'The path that the prompt should render for.'
complete -c starship -n "__fish_seen_subcommand_from timings" -s P -l logical-path -d 'The logical path that the prompt should render for. This path should be a virtual/logical representation of the PATH argument.'
complete -c starship -n "__fish_seen_subcommand_from timings" -s d -l cmd-duration -d 'The execution duration of the last command, in milliseconds'
complete -c starship -n "__fish_seen_subcommand_from timings" -s k -l keymap -d 'The keymap of fish/zsh'
complete -c starship -n "__fish_seen_subcommand_from timings" -s j -l jobs -d 'The number of currently running jobs'
