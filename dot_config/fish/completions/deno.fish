...
complete -c deno -n "__fish_seen_subcommand_from bundle" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from cache" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from cache" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from compile" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l allow-ffi -d 'Allow loading dynamic libraries' -r
complete -c deno -n "__fish_seen_subcommand_from compile" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
...
complete -c deno -n "__fish_seen_subcommand_from doc" -l import-map -d 'Load import map file' -r
complete -c deno -n "__fish_seen_subcommand_from doc" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from eval" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
...
complete -c deno -n "__fish_seen_subcommand_from info" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from info" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from install" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from install" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from install" -l allow-ffi -d 'Allow loading dynamic libraries' -r
...
complete -c deno -n "__fish_seen_subcommand_from install" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
...
complete -c deno -n "__fish_seen_subcommand_from install" -l root -d 'Installation root' -r
...
complete -c deno -n "__fish_seen_subcommand_from uninstall" -l root -d 'Installation root' -r
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from repl" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
...
complete -c deno -n "__fish_seen_subcommand_from run" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from run" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from run" -l allow-ffi -d 'Allow loading dynamic libraries' -r
...
complete -c deno -n "__fish_seen_subcommand_from run" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
...
complete -c deno -n "__fish_seen_subcommand_from test" -l import-map -d 'Load import map file' -r
...
complete -c deno -n "__fish_seen_subcommand_from test" -s r -l reload -d 'Reload source code cache (recompile TypeScript)' -r
...
complete -c deno -n "__fish_seen_subcommand_from test" -l allow-ffi -d 'Allow loading dynamic libraries' -r
...
complete -c deno -n "__fish_seen_subcommand_from test" -l location -d 'Value of \'globalThis.location\' used by some web APIs' -r
