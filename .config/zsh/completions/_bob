...
'-h[Print help]' \
'--help[Print help]' \
'::version -- Optional Version to be uninstalled |nightly|stable|<version-string>|<commit-hash>| If no Version is provided a prompt is used to select the versions to be uninstalled:' \
&& ret=0
;;
(rm)
_arguments "${_arguments_options[@]}" : \
